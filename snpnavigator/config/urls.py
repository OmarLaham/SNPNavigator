...
urlpatterns = [
    ...
    path("json_snp_query/<str:run_id>/<str:spec_chr>/<str:open_peak_cell_types>/<int:cpg_island>/<int:close_to_another_open_peak>/<str:diseases_peaks_match>/<str:diseases_peaks_mismatch>", views.json_snp_query, name="json_snp_query"),
